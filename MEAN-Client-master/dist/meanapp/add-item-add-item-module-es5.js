...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-item-add-item-module"], {
  ...
  function srcAppAddItemAddItemRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "AddItemRoutingModule", function () {
      return AddItemRoutingModule;
    });
    /* harmony import */
    ...
    var _add_item_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./add-item.component */
    "./src/app/add-item/add-item.component.ts");

    var routes = [{
      path: '',
      component: _add_item_component__WEBPACK_IMPORTED_MODULE_3__["AddItemComponent"]
    }];

    var AddItemRoutingModule = function AddItemRoutingModule() {
      _classCallCheck(this, AddItemRoutingModule);
    };

    AddItemRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppAddItemAddItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AddItemComponent = /*#__PURE__*/function () {
      ...
      _createClass(AddItemComponent, [{
        ...
        key: "addItem",
        value: function addItem(formData) {
          var _this = this;

          this.itemsService.postItem(formData).subscribe(function (res) {
            console.log(res);
        ...
        value: function ngOnInit() {
          ...
          this.itemsForm.valueChanges.subscribe(function (values) {
            console.log(values);

            _this2.onFormChanges(values);
          });
        }
      }]);
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_items_service__WEBPACK_IMPORTED_MODULE_2__["ItemsService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])], AddItemComponent);
    /***/
  },
  ...
  function srcAppAddItemAddItemModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "AddItemModule", function () {
    ...
    var _add_item_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./add-item-routing.module */
    "./src/app/add-item/add-item-routing.module.ts");
    /* harmony import */


    var _add_item_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./add-item.component */
    "./src/app/add-item/add-item.component.ts");
    /* harmony import */
    ...
    var AddItemModule = function AddItemModule() {
      _classCallCheck(this, AddItemModule);
    };

    AddItemModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_add_item_routing_module__WEBPACK_IMPORTED_MODULE_3__["AddItemRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"]],
